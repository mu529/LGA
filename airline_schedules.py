...
maxsize = api.service.SetMaximumResultSize(max_size = 7000)
#print api
...
effdate = int(time.mktime(time.strptime('2015-09-14 04:00:00', '%Y-%m-%d %H:%M:%S'))) - time.timezone
discdate = int(time.mktime(time.strptime('2015-09-21 03:59:00', '%Y-%m-%d %H:%M:%S'))) - time.timezone

result = api.service.AirlineFlightSchedules(startDate=effdate, endDate=discdate, origin='KLGA', howMany=6999, offset=0)
# result[1][1]
...
schedules.to_csv('flight_schedules_import.csv')